...
define(['Controllers/Controller', 'Utils/events', 'Utils/css', 'Utils/when', 'Utils/pubsub', 'Utils/polyfills'], function(C, events, css, when, ps){
	...
	Controller.bindEvents = function() {
		...
		// First we grab the Template (which uses {{property_name}} syntax) we need to use for the View
		this.getTemplate('test.tmpl').then(function(template) {
